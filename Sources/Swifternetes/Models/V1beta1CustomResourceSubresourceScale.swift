//
// V1beta1CustomResourceSubresourceScale.swift
//
...
public struct V1beta1CustomResourceSubresourceScale: Codable {
    ...
    public init(labelSelectorPath: String?, specReplicasPath: String, statusReplicasPath: String) {
