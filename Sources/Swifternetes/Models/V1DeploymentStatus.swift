...
public struct V1DeploymentStatus: Codable {
    ...
    public var conditions: [V1DeploymentCondition]?
    ...
    public init(availableReplicas: Int?, collisionCount: Int?, conditions: [V1DeploymentCondition]?, observedGeneration: Int64?, readyReplicas: Int?, replicas: Int?, unavailableReplicas: Int?, updatedReplicas: Int?) {
