...
public struct V1beta1DaemonSetStatus: Codable {

    /** Count of hash collisions for the DaemonSet. The DaemonSet controller uses this field as a collision avoidance mechanism when it needs to create the name for the newest ControllerRevision. */
    public var collisionCount: Int?
    /** Represents the latest available observations of a DaemonSet&#39;s current state. */
    public var conditions: [V1beta1DaemonSetCondition]?
    ...
    public init(collisionCount: Int?, conditions: [V1beta1DaemonSetCondition]?, currentNumberScheduled: Int, desiredNumberScheduled: Int, numberAvailable: Int?, numberMisscheduled: Int, numberReady: Int, numberUnavailable: Int?, observedGeneration: Int64?, updatedNumberScheduled: Int?) {
