...
public struct V1ObjectMeta: Codable {
    ...
    public var managedFields: [V1ManagedFieldsEntry]?
    ...
    public var ownerReferences: [V1OwnerReference]?
    ...
    public init(annotations: [String:String]?, clusterName: String?, creationTimestamp: Date?, deletionGracePeriodSeconds: Int64?, deletionTimestamp: Date?, finalizers: [String]?, generateName: String?, generation: Int64?, labels: [String:String]?, managedFields: [V1ManagedFieldsEntry]?, name: String?, namespace: String?, ownerReferences: [V1OwnerReference]?, resourceVersion: String?, selfLink: String?, uid: String?) {
