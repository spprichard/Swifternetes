//
// V1ISCSIPersistentVolumeSource.swift
//
...
public struct V1ISCSIPersistentVolumeSource: Codable {
    ...
    public init(chapAuthDiscovery: Bool?, chapAuthSession: Bool?, fsType: String?, initiatorName: String?, iqn: String, iscsiInterface: String?, lun: Int, portals: [String]?, readOnly: Bool?, secretRef: V1SecretReference?, targetPortal: String) {
