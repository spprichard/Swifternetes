//
// ExtensionsV1beta1PodSecurityPolicySpec.swift
//
...
public struct ExtensionsV1beta1PodSecurityPolicySpec: Codable {
    ...
    public var allowedCSIDrivers: [ExtensionsV1beta1AllowedCSIDriver]?
    ...
    public var allowedFlexVolumes: [ExtensionsV1beta1AllowedFlexVolume]?
    /** allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used. */
    public var allowedHostPaths: [ExtensionsV1beta1AllowedHostPath]?
    ...
    public var fsGroup: ExtensionsV1beta1FSGroupStrategyOptions
    ...
    public var hostPorts: [ExtensionsV1beta1HostPortRange]?
    ...
    public var runAsGroup: ExtensionsV1beta1RunAsGroupStrategyOptions?
    public var runAsUser: ExtensionsV1beta1RunAsUserStrategyOptions
    public var runtimeClass: ExtensionsV1beta1RuntimeClassStrategyOptions?
    public var seLinux: ExtensionsV1beta1SELinuxStrategyOptions
    public var supplementalGroups: ExtensionsV1beta1SupplementalGroupsStrategyOptions
    /** volumes is a white list of allowed volume plugins. Empty indicates that no volumes may be used. To allow all volumes you may use &#39;*&#39;. */
    public var volumes: [String]?

    public init(allowPrivilegeEscalation: Bool?, allowedCSIDrivers: [ExtensionsV1beta1AllowedCSIDriver]?, allowedCapabilities: [String]?, allowedFlexVolumes: [ExtensionsV1beta1AllowedFlexVolume]?, allowedHostPaths: [ExtensionsV1beta1AllowedHostPath]?, allowedProcMountTypes: [String]?, allowedUnsafeSysctls: [String]?, defaultAddCapabilities: [String]?, defaultAllowPrivilegeEscalation: Bool?, forbiddenSysctls: [String]?, fsGroup: ExtensionsV1beta1FSGroupStrategyOptions, hostIPC: Bool?, hostNetwork: Bool?, hostPID: Bool?, hostPorts: [ExtensionsV1beta1HostPortRange]?, privileged: Bool?, readOnlyRootFilesystem: Bool?, requiredDropCapabilities: [String]?, runAsGroup: ExtensionsV1beta1RunAsGroupStrategyOptions?, runAsUser: ExtensionsV1beta1RunAsUserStrategyOptions, runtimeClass: ExtensionsV1beta1RuntimeClassStrategyOptions?, seLinux: ExtensionsV1beta1SELinuxStrategyOptions, supplementalGroups: ExtensionsV1beta1SupplementalGroupsStrategyOptions, volumes: [String]?) {
