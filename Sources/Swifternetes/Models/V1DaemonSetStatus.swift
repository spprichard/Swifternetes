...
public struct V1DaemonSetStatus: Codable {

    /** Count of hash collisions for the DaemonSet. The DaemonSet controller uses this field as a collision avoidance mechanism when it needs to create the name for the newest ControllerRevision. */
    public var collisionCount: Int?
    /** Represents the latest available observations of a DaemonSet&#39;s current state. */
    public var conditions: [V1DaemonSetCondition]?
    ...
    public init(collisionCount: Int?, conditions: [V1DaemonSetCondition]?, currentNumberScheduled: Int, desiredNumberScheduled: Int, numberAvailable: Int?, numberMisscheduled: Int, numberReady: Int, numberUnavailable: Int?, observedGeneration: Int64?, updatedNumberScheduled: Int?) {
