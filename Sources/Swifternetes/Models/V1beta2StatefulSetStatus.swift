//
// V1beta2StatefulSetStatus.swift
//
...
public struct V1beta2StatefulSetStatus: Codable {

    /** collisionCount is the count of hash collisions for the StatefulSet. The StatefulSet controller uses this field as a collision avoidance mechanism when it needs to create the name for the newest ControllerRevision. */
    public var collisionCount: Int?
    /** Represents the latest available observations of a statefulset&#39;s current state. */
    public var conditions: [V1beta2StatefulSetCondition]?
    ...
    public init(collisionCount: Int?, conditions: [V1beta2StatefulSetCondition]?, currentReplicas: Int?, currentRevision: String?, observedGeneration: Int64?, readyReplicas: Int?, replicas: Int, updateRevision: String?, updatedReplicas: Int?) {
