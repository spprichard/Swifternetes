...
public struct V1StatefulSetStatus: Codable {
    ...
    public init(collisionCount: Int?, conditions: [V1StatefulSetCondition]?, currentReplicas: Int?, currentRevision: String?, observedGeneration: Int64?, readyReplicas: Int?, replicas: Int, updateRevision: String?, updatedReplicas: Int?) {
