...
public struct V1beta1MutatingWebhook: Codable {
    ...
    public var clientConfig: AdmissionregistrationV1beta1WebhookClientConfig
    ...
    public var rules: [V1beta1RuleWithOperations]?
    ...
    public init(admissionReviewVersions: [String]?, clientConfig: AdmissionregistrationV1beta1WebhookClientConfig, failurePolicy: String?, matchPolicy: String?, name: String, namespaceSelector: V1LabelSelector?, objectSelector: V1LabelSelector?, reinvocationPolicy: String?, rules: [V1beta1RuleWithOperations]?, sideEffects: String?, timeoutSeconds: Int?) {
