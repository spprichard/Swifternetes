...
public struct V1ServiceSpec: Codable {
    ...
    public var healthCheckNodePort: Int?
    ...
    public var ports: [V1ServicePort]?
    ...
    public var sessionAffinityConfig: V1SessionAffinityConfig?
    ...
    public init(clusterIP: String?, externalIPs: [String]?, externalName: String?, externalTrafficPolicy: String?, healthCheckNodePort: Int?, ipFamily: String?, loadBalancerIP: String?, loadBalancerSourceRanges: [String]?, ports: [V1ServicePort]?, publishNotReadyAddresses: Bool?, selector: [String:String]?, sessionAffinity: String?, sessionAffinityConfig: V1SessionAffinityConfig?, topologyKeys: [String]?, type: String?) {
