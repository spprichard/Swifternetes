...
public struct V1MutatingWebhook: Codable {
    ...
    public init(admissionReviewVersions: [String], clientConfig: AdmissionregistrationV1WebhookClientConfig, failurePolicy: String?, matchPolicy: String?, name: String, namespaceSelector: V1LabelSelector?, objectSelector: V1LabelSelector?, reinvocationPolicy: String?, rules: [V1RuleWithOperations]?, sideEffects: String, timeoutSeconds: Int?) {
