...
public struct V1DeploymentSpec: Codable {
    ...
    public var strategy: V1DeploymentStrategy?
    public var template: V1PodTemplateSpec

    public init(minReadySeconds: Int?, paused: Bool?, progressDeadlineSeconds: Int?, replicas: Int?, revisionHistoryLimit: Int?, selector: V1LabelSelector, strategy: V1DeploymentStrategy?, template: V1PodTemplateSpec) {
