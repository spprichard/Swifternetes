//
// AppsV1beta1DeploymentStatus.swift
//
...
public struct AppsV1beta1DeploymentStatus: Codable {
    ...
    public var conditions: [AppsV1beta1DeploymentCondition]?
    ...
    public init(availableReplicas: Int?, collisionCount: Int?, conditions: [AppsV1beta1DeploymentCondition]?, observedGeneration: Int64?, readyReplicas: Int?, replicas: Int?, unavailableReplicas: Int?, updatedReplicas: Int?) {
